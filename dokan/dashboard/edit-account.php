        ...
        <div class="dokan-dashboard-content">
            ...
            ?>
                ...
                <article class="dashboard-content-area woocommerce edit-account-wrap">
                    ...
                    <h1 class="entry-title mb-5"><?php esc_html_e( 'Edit Account Details', 'dokan-lite' ); ?></h1>
                    ...
                    <form class="edit-account" action="" method="post">
                        ...
                        <p>
                            ...
                            <input type="submit" class="btn btn-primary" name="dokan_save_account_details" value="<?php esc_attr_e( 'Save changes', 'dokan-lite' ); ?>" />
