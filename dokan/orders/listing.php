...
if ( $user_orders ) {
    ...
    <form id="order-filter" method="POST" class="dokan-form-inline">
            ...
            <div class="col-lg-auto px-0">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text screen-reader-text">عملیات</span>
                    </div>
                    <select name="status" id="bulk-order-action-selector" class="form-control chosen">
                    ...
                    <div class="input-group-append">
                        ...
                        <input type="submit" name="bulk_order_status_change" id="bulk-order-action" class="btn btn-primary" value="<?php esc_attr_e( 'Apply', 'dokan-lite' ); ?>">
                    </div>
                </div>
            </div>
        </div>
        ...
        <table class="dokan-table dokan-table-striped">
            <thead>
                <tr>
                    <th id="cb" class="manage-column column-cb check-column ns-checkbox">
            ...
            <tbody>
                ...
                foreach ($user_orders as $order) {
                    ...
                    ?>
                    <tr >
                        <td class="dokan-order-select ns-checkbox">
                            <input id="cb-select-<?php echo esc_attr( $order->order_id ); ?>" class="cb-select-items dokan-checkbox" type="checkbox" name="bulk_orders[]" value="<?php echo esc_attr( $order->order_id ); ?>">
                        ...
                        <?php if ( current_user_can( 'dokan_manage_order' ) ): ?>
                            <td class="dokan-order-action text-left" width="17%" data-title="<?php esc_attr_e( 'Action', 'dokan-lite' ); ?>" >
                                <?php
