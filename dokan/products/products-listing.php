                        ...
                        <div class="row w-100 mb-4">
                            ...
                            <div class="col-lg-auto px-0">
                                <div class="input-group">
                                    ...
                                    <select name="status" id="bulk-product-action-selector" class="form-control chosen">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <input type="submit" name="bulk_product_status_change" id="bulk-product-action" class="btn btn-primary" value="<?php esc_attr_e( 'Apply', 'dokan-lite' ); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
