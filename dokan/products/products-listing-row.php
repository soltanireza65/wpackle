...
<tr class="<?php echo esc_attr( $tr_class ); ?>">
    <td class="dokan-product-select ns-checkbox">
        <input id="cb-select-<?php echo esc_attr( $post->ID ); ?>" class="cb-select-items dokan-checkbox" type="checkbox" name="bulk_products[]" value="<?php echo esc_attr( $post->ID ); ?>">
