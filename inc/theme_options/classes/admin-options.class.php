...
if ( ! class_exists( 'CSF_Options' ) ) {
  class CSF_Options extends CSF_Abstract {
    ...
    public $args         = array(
      ...
      // framework title
      'framework_title'         => 'فریمورک Codestar <small>داناپیوست</small>',
      'framework_class'         => '',
    ...
    public function add_admin_footer_text() {
      $default = 'از اینکه به ما اعتماد کردید، سپاسگذاریم <a href="http://codestarframework.com/" target="_blank">فریمورک Codestar</a>';
