  ...
  class CSF_Field_typography extends CSF_Fields {
    ...
    public function render() {
      ...
      $args                  = wp_parse_args( $this->field, array(
        ...
        'unit'               => 'px',
        'line_height_unit'   => '',
        'preview_text'       => 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است | Lorem ipsum dolor sit amet, consectetur adipiscing elit',
      ) );
