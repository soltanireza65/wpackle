...
<div class="yith-wcwl-wishlistaddedbrowse mr-2" data-product-id="<?php echo esc_attr( $product_id ); ?>" data-original-product-id="<?php echo esc_attr( $parent_product_id ); ?>">
<!--	<span class="feedback">-->
